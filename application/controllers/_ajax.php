...
class _ajax extends CI_Controller {
    ...
    public function basket_update_items()
    {
    ...
    public function basket_remove_item()
    {
...
//        }
    ...
    public function save_details()
    {
            ...
            if ($this->input->post('title')!='' && $this->input->post('firstname')!='' && $this->input->post('lastname')!='' && $_POST['email']!='' && $this->input->post('address1')!='' && $this->input->post('city')!='' && $this->input->post('postcode')!='' && $this->input->post('country')!='' && $this->input->post('shipping')!='' && valid_email($_POST['email'])){
    ...
    public function sort_view_categories()
    {
    ...
    public function edit_shipping_country()
    {
            if ($this->session->userdata('user_level')!=1){
                    $data['msg'] = 'Admin Only!';
            }else{
    ...
    public function edit_product_shipping()
    {
            if ($this->session->userdata('user_level')!=1){
                    $data['msg'] = 'Admin Only!';
            }else{
    ...
    public function sort_alpha_products()
    {
            if ($this->session->userdata('user_level')!=1){
                    $data['msg'] = 'Admin Only!';
            }else{
    ...
    public function sort_alpha_categories()
    {
            if ($this->session->userdata('user_level')!=1){
                    $data['msg'] = 'Admin Only!';
            }else{
