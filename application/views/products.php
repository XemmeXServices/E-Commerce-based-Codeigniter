...
if ($products['image']!=''){
	$image_file = 'assets/images/products/'.$products['image'];
	if (file_exists($image_file)){
		echo '<a href="'.url().'lightbox/i/'.$products['image'].'" class="lbOn">'.image_thumb('assets/images/products/'.$products['image'], 150, 150);
		echo '<br><img src="'.url().'assets/images/zoom.gif" alt="Zoom">Zoom</a>';
	}else{
		echo '<img src="'.url().'assets/images/noimage_150x150.gif" alt="No Image!">';
	}
}else{
	echo '<img src="'.url().'assets/images/noimage_150x150.gif" alt="No Image!">';
}
