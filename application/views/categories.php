...
foreach ($products as $product_info) {
	...
	if ($product_info['image']!=''){
		$image_file = 'assets/images/products/'.$product_info['image'];
		if (file_exists($image_file)){
			echo '<a href="'.url().'products/p/'.$product_info['key'].'">'.image_thumb('assets/images/products/'.$product_info['image'], 100, 100).'</a>';
		}else{
			echo '<a href="'.url().'products/p/'.$product_info['key'].'"><img src="'.url().'assets/images/noimage_100x100.gif" alt="No Image!"></a>';
		}
	}else{
