 ...
 *
 * The Admin Sub Categories view to be used with Total Shop UK eCommerce Open Source
 *
...
<?php
echo '<div class="breadcrumb">Admin&nbsp;&gt;&nbsp;<a href="'.url().'admin/categories">Categories</a>&nbsp;>&nbsp;<strong>'.$category_title.'</strong></div>';
?>
...
if ($cats==1){	
	foreach ($category as $category_info) {
		...
		echo '<tr><td><input type="text" id="title_'.$category_info['key'].'" class="textstyle" style="width:200px" value="'.$category_info['title'].'">&nbsp;<input type="button" class="buttonstyle" value="Save" onclick="save_category(\''.$category_info['key'].'\',\'edit\');">&nbsp;<input type="button" class="buttonstyle" value="Delete" onclick="save_category(\''.$category_info['key'].'\',\'delete\');"></td><td><img src="'.url().'images/icon_drag.png" alt="Move"><span id="status_'.$category_info['key'].'" style="display:none"></span></td></tr>';
		echo '</table>';
		echo '</div>';
		$i++;
	}
