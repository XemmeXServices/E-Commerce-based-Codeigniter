 ...
 *
 * The Paymodule Paypal view to be used with Total Shop UK eCommerce Open Source
 *
...
function pay_data(){
	document.getElementById('pay_button').innerHTML='<img src="<?php echo url(); ?>images/paypal_grey.gif" alt=""><br>Please Wait...';
	save_clear();
}
function postdata(){
...
function save_clear(){
	...
	ajax('<?php echo url(); ?>_ajax/save_basket', 'empty_status', poststr, 'POST', '', postdata);
}
</script>
<div style="text-align:center;font-size:13px"><a href="<?php echo url(); ?>checkout">Checkout</a>&nbsp;&gt;&nbsp;<a href="<?php echo url(); ?>checkout/delivery">Delivery</a>&nbsp;&gt;&nbsp;<span style="font-weight:bold;color:#990000">Summary</span>&nbsp;&gt;&nbsp;Payment</div><br>
<table class="normal" align="center" width="506px" style="border:1px solid #7A7A9A;background:#F1F1F1;padding:2px">
	...
	echo '<tr><td colspan="3" align="right"><strong>Shipping ('.$shipping['title'].')</strong></td><td><strong>&pound;'.number_format($shipping['price'],2).'</strong></td></tr>';
	...
	<tr>
		<td colspan="4" align="center">
			...
			<input type="hidden" name="business" value="sales@totalshopuk.com"> 
			<?php
			$i=1;
			...
			<input type="hidden" name="return" value="<?php echo base_url(); ?>checkout/paypal_success">
			<input type="hidden" name="cancel_return" value="<?php echo base_url(); ?>checkout/order_cancelled">
			<input type="hidden" name="currency_code" value="GBP">
			<input type="hidden" name="lc" value="GB">
			<input type="hidden" name="bn" value="PP-BuyNowBF">
			<span id="pay_button"><a href="javascript:pay_data();"><img src="<?php echo url(); ?>images/paypal.gif" alt="PayPal - The safer, easier way to pay online"></a></span><br><br>or<br><br>
			<input id="continue_shopping" type="button" class="buttonstyle" value="Continue Shopping" onclick="parent.location='<?php echo url(); ?>'">
